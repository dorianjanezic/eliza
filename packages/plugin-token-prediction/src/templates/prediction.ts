...
1. Entry Decision
   ...
   - Consider BUY if the token shows strong growth potential.
   - Consider IGNORE if the token appears stagnant, declining, or overly concentrated.
   - Weigh factors like unique_traders_1h, market_cap, holders, and total_transactions.
2. Market Cap Predictions
   - Provide specific market cap predictions for 2, 4, 6, 8, and 10 minutes after this update.
   - Base predictions on current_metrics (market_cap, unique_traders_1h, holders, volume_1hUSD), concentration (top_10_percentage), and activity (total_transactions, reply_count).
   - Use timing (inception_datetime, pair_created_at) to assess token age and momentum.
3. Risk Assessment
   - Identify risks such as high top_10_percentage or pumpfun_top_10_holders_percentage (>50%), or few unique_traders_1h or low volume_1hUSD.
